...
export const UPDATE_WINNER_SORT = 'UPDATE_WINNER_SORT';
export const UPDATE_WINNER_POTS = 'UPDATE_WINNER_POTS';
export const FETCH_WINNERS_BEGIN = 'FETCH_WINNERS_BEGIN';
export const FETCH_WINNERS_SUCCESS = 'FETCH_WINNERS_SUCCESS';
export const FETCH_WINNERS_FAILURE = 'FETCH_WINNERS_FAILURE';
