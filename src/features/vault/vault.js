          ...
          <Grid container>
              ...
              <Grid container>
                ...
                <Grid item xs={8}>
                  ...
                  <Typography className={classes.potUsd} align={'right'}>
                    <span>{t('in')}</span>
                    <PrizeSplit item={item} withBalances={false} />
                  </Typography>
                ...
                <Grid item xs={6} style={{ paddingRight: '8px' }}>
                  ...
                  <Typography className={classes.countdown} align={'left'}>
                ...
                <Grid item xs={6} style={{ paddingLeft: '8px' }}>
                  ...
                  <Typography className={classes.apy} style={{ color: '#ffffff' }}>
                    ...
                    <Grid container spacing={1}>
                      <Grid item xs={4} align={'left'}>
                        <Typography className={classes.prizeSplitWinners}>
                          {item.numberOfWinners.toString()} winners
                        </Typography>
                      </Grid>
                ...
                <Grid item xs={12}>
                  <Typography className={classes.fairplayDepositMessage}>
                    ...
                    <Link onClick={() => window.scrollTo(0, fairPlayRef.current.offsetTop)}>
                      {t('buttons.learnMore')}
                    </Link>
                  </Typography>
                </Grid>
            ...
            <Grid item xs={12}>
              <Typography className={classes.beefy}>
                {t('footerPoweredBy')} <Link href={'https://beefy.finance'}>Beefy.Finance</Link>
                <img
                  alt="Beefy Finance"
                  srcSet="
