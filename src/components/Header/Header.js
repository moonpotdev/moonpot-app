...
function Sidebar() {
	...
	return <>
		<IconButton className={classes.toggleSidebar} color="inherit" aria-label="Show Sidebar" onClick={handleOpen}>
			<MenuIcon/>
		</IconButton>
		<Drawer anchor="right" open={isOpen} onClose={handleClose} classes={{paper: classes.sidebar}}>
			<div className={classes.sidebarTop}>
				<IconButton className={classes.toggleSidebar} color="inherit" aria-label="Hide Sidebar"
							onClick={handleClose}>
					<CloseIcon/>
				</IconButton>
			</div>
